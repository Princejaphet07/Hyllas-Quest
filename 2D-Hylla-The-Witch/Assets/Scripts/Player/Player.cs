...
public class Player : Singleton<Player> {
    ...
    [SerializeField] private AudioSource footstepAudioSource; // BAG-ONG GIDUGANG PARA SA TUNOB
    ...
    private void GameInput_OnPlayerAttack(object sender, System.EventArgs e) {
        ...
        // BAG-ONG GIDUGANG PARA MOTINGOG ANG HAPAK
    ...
    private void HandleMovement() {
        ...
        if (Mathf.Abs(inputVector.x) > minMovingSpeed || Mathf.Abs(inputVector.y) > minMovingSpeed) {
            ...
            // BAG-ONG GIDUGANG: I-PLAY ANG TUNOB KUNG NAGLAKAW UG WALA PA NAG-PLAY
            ...
            // BAG-ONG GIDUGANG: I-STOP ANG TUNOB KUNG NI-HUNONG NA
            if (footstepAudioSource != null && footstepAudioSource.isPlaying) {
